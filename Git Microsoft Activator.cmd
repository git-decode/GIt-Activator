...
set KMS_Port=1688
If defined Renewal_Task call :Re_Activate>>"logfile.txt"&exit
If defined Run_Once call :Re_Activate>>"logfile.txt"&exit
:Re_Activate
echo ==============================================
...
if defined Run_Once (schtasks /delete /tn Online_KMS_Activation_Script-Run_Once /f 1>nul 2>nul &del /f /q C:\Windows\Microsoft Activation Renewal\Online_KMS_Activation_Script-Run_Once.cmd >nul 2>&1 &echo Exiting...&exit)
Echo.
echo Press any key to Continue.
pause>nul
Goto:EOF
